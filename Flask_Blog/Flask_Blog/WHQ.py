...
PRCDT6 = ['NNS', 'VBG', 'VBP', 'NN', 'IN', 'DT', 'NN']  # cats are making voice in the
PRCDT10 = ['NNP','VBG','VBZ','NNP','NNS']   # John is making bachelor nowadays
...
PAS11 = ['NNP','VBD','IN','DT','NN']     # John studied in a university
...
############End MD Lists #########
#When
WMD1 = ['MD', 'NNP', 'VB','NN','RB']  # Mina will play football tommorow
WMDIN1 = ['MD', 'NNP', 'VB','NN','IN','NN','RB']  # Mina will play football in club tommorow
WMDDT1 = ['MD', 'NNP', 'VB','NN','IN','DT','NN','RB']  # Mina will play football in the club tommorow
WMD2 = ['MD', 'PRP', 'VB','NN']  # He will play football tommorow
WMDIN2 = ['MD', 'PRP', 'VB','NN','IN','NN','RB']  # He will play football in club tommorow
WMDDT2 = ['MD', 'PRP', 'VB','NN','IN','DT','NN','RB']  # He will play football in the club tommorow
WMD3 = ['MD', 'NNPS', 'VB','NN','RB']  # Mina and Omar will play football tommorow
WMDIN3 = ['MD', 'NNPS', 'VB','NN','IN','NN','RB']  # Mina and Omar will play football in club tommorow
WMDDT3 = ['MD', 'NNPS', 'VB','NN','IN','DT','NN','RB']  # Mina and Omar will play football in the club tommorow
WMD4 = ['MD', 'PRP', 'VB','NN','RB']  # They will play football tommorow
WMDIN4 = ['MD', 'PRP', 'VB','NN','IN','NN','RB']  # They will play football in club tommorow
WMDDT4 = ['MD', 'PRP', 'VB','NN','IN','DT','NN','RB']  # They will play football in the club tommorow
WMD5 = ['MD', 'NN', 'VB', 'NN','RB']  # Machine will produce product tommorow ----------------------
WMDIN5 = ['MD', 'NN', 'VB', 'NN','IN','NN','RB']  # Machine will produce product in factory tommorow
WMDDT5 = ['MD', 'NN', 'VB', 'NN','IN','DT','NN','RB']  # Machine will produce product in the factory tommorow
WMD6 = ['MD', 'NNS', 'VB', 'NN','RB']  # Machines will produce product tommorow ---------------------------------
WMDIN6 = ['MD', 'NNS', 'VB', 'NN','IN','NN','RB']  # Machines will produce product in factory tommorow
WMDDT6 = ['MD', 'NNS', 'VB', 'NN','IN','DT','NN','RB']  # Machines will produce product in the factory tommorow
############End MD Lists #########
...
def Generate_Questions(keyword_dic_sents, dic_NER):
    try:
        ...
        for key in keyword_dic_sents.keys():
            ...
            if ((dic_NER[key][0] == "NORP") or (dic_NER[key][0] == "PRODUCT") or (dic_NER[key][0] == "WORK_OF_ART") or (
                ...
                for sentence in keyword_dic_sents[key]:
                    ...
                    elif all(key in bucket for key in PRCDT10):  # 'NNPS', 'VBG', 'VBP' in sentence.
                        question = 'What' + ' ' + 'is' + ' ' + line.words[bucket['NNP']] + ' ' + line.words[
                            bucket['VBG']] + ' ' + line.words[bucket['NNS']] + '?'
                        print("PRCDT10")
                        questions.append(question)
            ...
            if (dic_NER[key][0] == "PERSON"):
                ...
                for sentence in keyword_dic_sents[key]:
                    ...
                    elif all(key in bucket for key in PRCDT10):  # 'NNP', 'VBG', 'VBZ' in sentence.
                        if line.words[bucket['NNP']] != j[0]:
                            question = 'Who' + ' ' + 'is' + ' ' + line.words[bucket['VBG']] + ' ' + \
                                       line.words[3] + ' ' + line.words[bucket['NNS']] + ' ' + '?'
                            print("PRCDT10")
                            questions.append(question)
                    ...
                    ############################## Present Simple ######################################
                        ...
                        if line.words[bucket['NNP']] != j[0]:
                            question = 'Who' + ' ' + line.words[bucket['VBZ']] + ' ' + line.words[bucket['IN']] + ' ' + j[0] + '?'
                            print('PRS8')
                            questions.append(question)
                    ...
                    ##################################################### MD ###########################################
                    elif all(key in bucket for key in MDN):  # 'NNS', 'VB' in sentence.
                        question = 'Who' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                       bucket['VB']] + ' ' + line.words[bucket['DT']] + ' ' +line.words[bucket['NN']] +'?'
                        print('MDN')
                        questions.append(question)
                    ...
                    if all(key in bucket for key in PAS11):  # 'NNP', 'VBZ' in sentence.
                        question = 'Who' + ' ' + line.words[bucket['VBD']] + ' ' + line.words[
                            bucket['IN']] + ' ' + line.words[bucket['DT']] + ' ' + line.words[bucket['NN']] + '?'
                        print('PAS11')
                        questions.append(question)
            ...
            if ((dic_NER[key][0] == "DATE") or (dic_NER[key][0] == "TIME")):
                ...
                for sentence in keyword_dic_sents[key]:
                    ...
                    ##################################################### MD ###########################################
                    elif all(key in bucket for key in WMDDT1):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                    ...
                    elif all(key in bucket for key in WMDIN1):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['NNP']] + ' ' + \
                                       line.words[
                    ...
                    elif all(key in bucket for key in WMD1):  # 'NNP', 'VB' in sentence.
                    ...
                    elif all(key in bucket for key in WMDDT2):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            if line.words[bucket['PRP']] in ['he', 'she', 'it', 'He', 'She', 'It']:
                                question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                    bucket['PRP']] + ' ' + \
                    ...
                    elif all(key in bucket for key in WMDIN2):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            if line.words[bucket['PRP']] in ['he', 'she', 'it', 'He', 'She', 'It']:
                                question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                    bucket['PRP']] + ' ' + \
                    ...
                    elif all(key in bucket for key in WMD2):  # 'PRP', 'VB' in sentence.
                        if line.words[bucket['PRP']] in ['he', 'she', 'it', 'He', 'She', 'It']:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['PRP']] + ' ' + line.words[
                                           bucket['VB']] + ' ' + '?'
                    ...
                    elif all(key in bucket for key in WMDDT3):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['NNPS']] + ' ' + \
                                       line.words[
                    ...
                    elif all(key in bucket for key in WMDIN3):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['NNPS']] + ' ' + \
                                       line.words[
                    ...
                    elif all(key in bucket for key in WMD3):  # 'NNPS', 'VB' in sentence.
                        question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                            bucket['NNPS']] + ' ' + line.words[
                                       bucket['VB']] + ' ' + '?'
                        print('WMD3')
                    ...
                    elif all(key in bucket for key in WMDDT4):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            if line.words[bucket['PRP']] in ['i', 'you', 'we', 'they', 'I', 'You', 'We', 'They']:
                                question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                    bucket['PRP']] + ' ' + \
                    ...
                    elif all(key in bucket for key in WMDIN4):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            if line.words[bucket['PRP']] in ['i', 'you', 'we', 'they', 'I', 'You', 'We', 'They']:
                                question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                    bucket['PRP']] + ' ' + \
                    ...
                    elif all(key in bucket for key in WMD4):  # 'NNS', 'VB' in sentence.
                        if line.words[bucket['PRP']] in ['i', 'you', 'we', 'they', 'I', 'You', 'We', 'They']:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['PRP']] + ' ' + line.words[
                                           bucket['VB']] + ' ' + '?'
                    ...
                    elif all(key in bucket for key in WMDDT5):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                    ...
                    elif all(key in bucket for key in WMDIN5):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[bucket['NN']] + ' ' + \
                                       line.words[
                                           bucket['VB']] + ' ' + \
                    ...
                    elif all(key in bucket for key in WMD5):  # 'NNP', 'VB' in sentence.
                        question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[bucket['NN']] + ' ' + \
                                   line.words[
                                       bucket['VB']] + ' ' + '?'
                        print('WMD5')
                    ...
                    elif all(key in bucket for key in WMDDT6):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['NNS']] + ' ' + \
                                       line.words[
                    ...
                    elif all(key in bucket for key in WMDIN6):  # 'NNP', 'VB' in sentence.
                        if line.words[bucket['NN']] != j[0]:
                            question = 'When' + ' ' + line.words[bucket['MD']] + ' ' + line.words[
                                bucket['NNS']] + ' ' + \
                                       line.words[
                    ...
                    elif all(key in bucket for key in WMD6):  # 'NNP', 'VB' in sentence.
        ...
        print("No WH Questions Generated ")
        keyword_Questions_dic[key] = "No WH Questions Generated "
...
def main():
    ...
    lo = keywords_Q_FN("Ali lives in Alaska. he is making Master nowadays.")
    print(lo[0])
    print(lo[1])
    print(lo[2])
    print(lo[3])
